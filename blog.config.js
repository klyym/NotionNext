...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ONE CORN 玉米', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一粒做室内设计的玉米呀', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zy.onecorndesign.top/', // 网站地址
